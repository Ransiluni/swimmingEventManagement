          ...
          <div class="place">
                    ...
                    <form class="form" action = "" method="POST" >
                        ...
                        <div class="form__group">
                            ...
                            <input type="text"  name="event_id" id="event_id" placeholder="<?php echo $row->event_id; ?>" class="form__input" read only/>
                    ...
                    <button class="btn" name="register_subevent" >REGISTER SUBEVENT</button>
