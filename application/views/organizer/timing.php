    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#">Timing</a>
          </li>
          <li class="nav-item">
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        ...
        <div class="form__group">
                            ...
                            <label> No event scheduled to organize </label>
                            <?php }else{?>
                        
                            <?php foreach($event_today as $row): ?>
                    
                    
                            <input type="radio" name="event[]" value="<?php echo $row->event_id;?> " required/> <tr>   
        ...
        <button class="btn" name="event_today" >ORGANIZE EVENT</button>
       <?php }?>
