...
<div class="user">
    <header class="user__header">
     ...
     <form class="form" action = "" method="POST">
        ...
        <div class="form__group">
            <input type="date" name="date_of_burth" id="date_of_irth" placeholder="Date_of_birth" class="form__input" />
        </div>
        
        <div class="form__group">
            <input type="gender" name="gender" id="gender" placeholder="Gender" class="form__input" />
        </div>
        
        <div class="form__group">
            <input type="teamm_id" name="team_id" id="team_id" placeholder="Team_id" class="form__input" />
        </div>
